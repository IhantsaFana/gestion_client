<nav class="navbar navbar-light navbar-expand-md py-3">
    <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-64 0 512 512" width="1em" height="1em" fill="currentColor">
                ...
                </svg></span><span>FACTURATION</span></a>
        ...
        <div class="collapse navbar-collapse" id="navcol-3">
            ...
            <a href="<?= URLROOT ?>/users/login" class="btn btn-primary me-3" type="button">
                <i class="fas fa-sign-in-alt"></i>&nbsp;
                SE CONNECTER
            </a>
            <a href="<?= URLROOT ?>/users/register" class="btn btn-outline-light" type="button">
